...
def update_lace_modifier(self, context):
    ...
    if modifier:
        OBJECT_OT_add_lace_modifier.set_modifier_inputs(OBJECT_OT_add_lace_modifier, modifier, context)
        # Force refresh so geometry nodes update immediately
