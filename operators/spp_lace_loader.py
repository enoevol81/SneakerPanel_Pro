...
def load_lace_assets():
    ...
    if not asset_path.exists():
        ...
        print(f"Please ensure spp_lace_assets.blend exists in the assets folder")
        return False
            ...
            for node_group_name in node_groups_to_load:
                if node_group_name not in bpy.data.node_groups:
                    if node_group_name in data_from.node_groups:
                        ...
                        print(f"WARNING: Node group '{node_group_name}' not found in asset file")
            ...
            for material_name in materials_to_load:
                if material_name not in bpy.data.materials:
                    if material_name in data_from.materials:
                        ...
                        print(f"WARNING: Material '{material_name}' not found in asset file")
...
def ensure_lace_assets():
    ...
    required_groups = ["spp_lace_round", "spp_lace_oval", "spp_lace_flat", "spp_lace_custom"]
