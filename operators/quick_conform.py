...
class OBJECT_OT_quick_conform(Operator):
    ...
    def execute(self, context):
        ...
        if not shell or shell.type != 'MESH':
            self.report({'WARNING'}, "No valid shell object found. Please set a shell object in Panel Configuration.")
            return {'CANCELLED'}
        ...
        try:
            ...
            self.report({'INFO'}, f"Quick conform applied - mesh conformed to '{shell.name}'")
